    ...
    <div class="py-6 md:py-8">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-3 mb-8">
                ...
                <div>
                    <h1 class="text-2xl md:text-3xl font-bold text-gray-900">Edit Donor</h1>
                    <p class="text-gray-500 text-sm md:text-base">Update donor information</p>
                </div>
            </div>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div>
                                ...
                                <input type="file" id="profile_photo" name="profile_photo" accept="image/*"
                                    class="block w-full text-base text-gray-500 file:mr-4 file:py-4 file:px-6 file:rounded-2xl file:border-0 file:text-sm file:font-medium file:bg-red-50 file:text-red-700 hover:file:bg-red-100 transition">
                                ...
                                <div class="flex flex-wrap gap-x-8 gap-y-4">
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="gender" value="male"
                                            {{ old('gender', $donor->gender) == 'male' ? 'checked' : '' }}
                                            class="w-5 h-5 text-red-600 focus:ring-red-500">
                                        <span class="text-gray-700">Male</span>
                                    </label>
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="gender" value="female"
                                            {{ old('gender', $donor->gender) == 'female' ? 'checked' : '' }}
                                            class="w-5 h-5 text-red-600 focus:ring-red-500">
                                        <span class="text-gray-700">Female</span>
                                    </label>
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="gender" value="other"
                                            {{ old('gender', $donor->gender) == 'other' ? 'checked' : '' }}
                                            class="w-5 h-5 text-red-600 focus:ring-red-500">
                                    ...
                                    <div class="flex flex-wrap gap-x-6 gap-y-3">
                                        <label class="flex items-center gap-2 cursor-pointer">
                                            <input type="radio" name="availability_status" value="available"
                                                {{ old('availability_status', $donor->availability_status) == 'available' ? 'checked' : '' }}
                                                class="w-5 h-5 text-green-600 focus:ring-green-500">
                                            <span class="text-gray-700">Available</span>
                                        </label>
                                        <label class="flex items-center gap-2 cursor-pointer">
                                            <input type="radio" name="availability_status" value="not_available"
                                                {{ old('availability_status', $donor->availability_status) == 'not_available' ? 'checked' : '' }}
                                                class="w-5 h-5 text-red-600 focus:ring-red-500">
                            ...
                            <div>
                                ...
                                <textarea id="notes" name="notes" rows="4"
                                    class="block w-full rounded-2xl border-gray-300 focus:border-blue-500 focus:ring-blue-500 py-4 px-5 text-base">{{ old('notes', $donor->notes) }}</textarea>
                                <x-input-error :messages="$errors->get('notes')" class="mt-2" />
                            </div>
                        </div>

                        <!-- Action Buttons -->
                        <div class="flex flex-col sm:flex-row gap-3 pt-8 border-t border-gray-100">
