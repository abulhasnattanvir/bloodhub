            ...
            <form action="{{ route('admin.faqs.update', $faq) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="answer" rows="6"
                        class="w-full border rounded-xl px-4 py-3 focus:outline-none focus:border-red-500" required>{{ old('answer', $faq->answer) }}</textarea>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="number" name="position" value="{{ old('position', $faq->position) }}"
