        ...
        <div class="max-w-8xl mx-auto">
            <div class="bg-white p-6 rounded-3xl shadow-sm">
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <a href="{{ route('admin.menus.create') }}"
                        class="bg-red-600 text-white px-5 py-2 rounded-2xl hover:bg-red-700 transition">
                        + Add New Menu
                    </a>
                </div>

                <!-- MENU LIST -->
                <ul id="menu-list" class="space-y-2 min-h-[300px]">

                    @foreach ($menus as $menu)
                        <li class="menu-item bg-gray-50 p-4 rounded-2xl border flex justify-between items-center cursor-move"
                            data-id="{{ $menu->id }}">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                @if ($menu->parent_id)
                                    <span class="text-xs bg-blue-100 text-blue-600 px-2 py-1 rounded-full">Child</span>
                                @endif
                            </div>
                ...
                <button id="saveOrder"
                    class="mt-8 bg-red-600 hover:bg-red-700 text-white px-8 py-3 rounded-2xl font-medium transition">
                    💾 Save Order
                </button>
