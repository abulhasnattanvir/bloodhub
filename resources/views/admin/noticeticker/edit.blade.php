        ...
        <div class="bg-white rounded-2xl shadow-lg p-8">
            ...
            <form action="{{ route('admin.notice-ticker.update', $noticeTicker->id) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="title" value="{{ old('title', $noticeTicker->title) }}"
                ...
                <div class="mb-6">
                    ...
                    <input type="url" name="url" value="{{ old('url', $noticeTicker->url) }}"
                        class="w-full border border-gray-300 rounded-xl px-5 py-4 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition"
                ...
                <div class="mb-8">
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="is_active" value="1"
                            {{ old('is_active', $noticeTicker->is_active) ? 'checked' : '' }}
                ...
                <div class="flex gap-4">
                    <button type="submit"
                        class="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-4 px-6 rounded-xl transition duration-200">
