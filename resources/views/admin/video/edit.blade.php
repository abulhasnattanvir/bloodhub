    ...
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
                <form action="{{ route('green.update', $greenInitiative) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="6" required
                            class="w-full px-6 py-4 border @error('description') border-red-500 @else border-gray-300 @enderror rounded-3xl focus:outline-none focus:border-green-500 focus:ring-4 focus:ring-green-100 transition-all resize-y">
                        ...
                        @if ($greenInitiative->image)
                            <div class="mb-6">
                                ...
                                <img src="{{ asset('storage/' . $greenInitiative->image) }}"
                                    class="w-56 h-56 object-cover rounded-2xl shadow-md border border-gray-200"
