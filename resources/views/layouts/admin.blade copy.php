...
<body class="font-sans antialiased bg-gray-50" x-data="{ mobileSidebar: false, blogOpen: {{ request()->routeIs('admin.blog.*', 'admin.blog.categories.*', 'admin.blog.tags.*') ? 'true' : 'false' } }">
